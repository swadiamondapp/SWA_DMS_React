  ...
  return (
    <div ref={ref} className="print-renders-product">
      ...
      <div className="NewSlotPrint">
        {slotView?.map((item, index) =>
          item.caddesigns.map((design, designIndex) => (
            <div className="slot_items" style={{ gap: "8px",marginBottom:"15px" }}>
            ...
            <div className="" style={{ padding: "8px" }}>
                <div className="print_detail">
                    <div className="qrsection" style={{ paddingBottom: "90px" }}>
                        <div className="print_content" style={{ gap: "8px" }}>
                    ...
                    <div className="img_section" style={{ height: "120px" }}>
                        <img
                ...
                <div className="print_tag" style={{ gap: "8px", position: "relative", marginTop: "-12px", paddingBottom: "50px" }}>
                    <span>Tag : {design.Tag}</span>
                    <span>Findings : {design.Findings}</span>
                </div>

                <div className="approx_details" style={{ gap: "8px", position: "relative", marginTop: "17px" }}>
                    <div className="approx" style={{ gap: "8px" }}>
                        <h6
                            style={{
