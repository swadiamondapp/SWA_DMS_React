...
import { CENTRALHUB_NEW_SCAN_LIST, CENTRALHUB_NEW_SCAN_PRODUCTSCAN, CENTRALHUB_NEW_SCAN_PRODUCTSTATUS_DELETE, CENTRALHUB_NEW_SCAN_PRODUCTSTATUS_UPDATE, NEW_SCAN_LIST, NEW_SCAN_PRODUCTSCAN, NEW_SCAN_PRODUCTSTATUS_DELETE, NEW_SCAN_PRODUCTSTATUS_UPDATE } from "../../../Pages/Services/EndPoints";
...
export const warehoueScanTable = async (setScanTableData) => {
  ...
  export const newScanSearchFilter = async (
    searchListId,
    setTableData,
  ) => {
    debugger
