...
export const list_slot_central_hub = async (setIsLoading, setData,SearchWithName) => {
  try {
    const response = await apiService.get(`${LIST_SLOT_HUB}?slotnumber=${SearchWithName}`);
